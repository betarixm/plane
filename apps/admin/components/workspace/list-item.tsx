...
export const WorkspaceListItem = observer(function WorkspaceListItem() {
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center gap-2.5 text-11">
            {workspace.total_projects !== null && (
              <span className="flex items-center gap-1">
                <h3 className="font-medium text-secondary">Projects:</h3>
            ...
            {workspace.total_members !== null && (
              <>
                •
                <span className="flex items-center gap-1">
                  <h3 className="font-medium text-secondary">Members:</h3>
      ...
      <NewTabIcon width={14} height={16} className="flex-shrink-0 text-placeholder group-hover:text-secondary" />
    </a>
  );
});

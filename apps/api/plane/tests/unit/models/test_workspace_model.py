...
class TestWorkspaceModel:
    ...
    def test_workspace_creation(self):
        ...
        workspace = Workspace.objects.create(
            name="Test Workspace", slug="test-workspace", id=uuid4()
        )
    ...
    @pytest.mark.django_db
    def test_second_workspace_is_rejected_by_database(self):
        workspace = Workspace.objects.create(
            name="Only Workspace",
            slug="only-workspace",
        )
    ...
    @pytest.mark.django_db
    def test_singleton_workspace_cannot_be_deleted(self):
        workspace = Workspace.objects.create(
            name="Only Workspace",
            slug="only-workspace",
        )

...
urlpatterns = [
    path(
        "workspace/projects/<uuid:project_id>/project-estimates/",
    ...
    path(
        "workspace/projects/<uuid:project_id>/estimates/<uuid:estimate_id>/",
    ...
    path(
        "workspace/projects/<uuid:project_id>/estimates/<uuid:estimate_id>/estimate-points/<estimate_point_id>/",

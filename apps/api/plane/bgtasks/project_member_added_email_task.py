...
@shared_task
def project_member_added_email(current_site, project_member_id, added_by_id):
    try:
        added_by = User.objects.get(pk=added_by_id)
        ...
        context = {
            ...
            "email": member_email,
            "added_by_display_name": added_by.display_name,
        ...
        # Set the subject
        subject = "You were added to a Plane project"

        # Render the email template
        html_content = render_to_string("emails/notifications/project_membership_added.html", context)
